  ...
  return {
    ...
    actions: {
      ...
      registerUser: async (data) => {
        try {
          let response = await fetch(
            "https://friendly-enigma-5gvgvj5j6x99fv4xp-3001.app.github.dev/api/users",
            {
              method: "POST",
      ...
      getRecommendedGames_gameSelection: async (number_games) => {
        try {
          const response = await fetch(
            `https://friendly-enigma-5gvgvj5j6x99fv4xp-3001.app.github.dev/api/games_recommended/${number_games}`
          );
          if (response.ok) {
      ...
      getGameByName_gameSelection: async (game_name) => {
        try {
          const response = await fetch(
            `https://friendly-enigma-5gvgvj5j6x99fv4xp-3001.app.github.dev/api/search_game?name=${game_name}`
          );
          if (response.ok) {
            const data = await response.json();
